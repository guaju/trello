package finance.com.dragboard.drag;
...
import finance.com.dragboard.adapter.RecyclerViewHorizontalDataAdapter;
import finance.com.dragboard.adapter.RecyclerViewVerticalDataAdapter;
import finance.com.dragboard.pager.PagerRecyclerView;
import finance.com.dragboard.utils.AttrAboutPhone;
import finance.com.dragboard.utils.Logger;
...
public class DragHelper {
    ...
    private static final int HORIZONTAL_STEP = 60;// 横向滑动步伐.
    ...
    private void recyclerViewScrollHorizontal(final int x, final int y) {
        ...
        if (x > rightScrollBounce) {
            ...
            Log.e("guaju", "x="+x+"--rightScrollBounce--"+"rightScrollBounce");
